   ...
   public class CustoService
    {
        ...
        {
            int n = 0;
            string sql = "insert into USERINFO(CustoNo,CustoName,CustoSex,CustoTel,PassportType,CustoID,CustoAdress,CustoBirth,CustoType) values(@CustoNo," +
        ...
        {
            return CustoDao.SelectCustoByCustoNo(cno);
        }
        #endregion
