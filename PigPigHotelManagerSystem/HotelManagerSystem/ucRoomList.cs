...
namespace HotelManagerSystem
{
    public partial class ucRoomList : UserControl
    {
        ...
        {
            Room r = BLL.RoomService.SelectRoomByRoomNo(lblRoomNo.Text);
            if (lblCustoNo.Text != "")
            {
        ...
        private void tsmiChangeState_Click(object sender, EventArgs e)
        {
            ...
            roomstate.RoomStateId = Convert.ToInt32(BLL.RoomService.SelectRoomStateIdByRoomNo(lblRoomNo.Text));
            roomstate.RoomNo = lblRoomNo.Text;
